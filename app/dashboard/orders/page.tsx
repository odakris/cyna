...
export default function OrderHomePage() {
  ...
  const dateFilterFn: FilterFn<unknown> = (row, columnId, filterValue) => {
  ...
  const table = useReactTable({
    ...
    filterFns: {
      global: globalFilterFunction as FilterFn<unknown>,
      dateRange: dateFilterFn, // Assurez-vous que cette ligne existe
    },
