...
export async function POST(req: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    // Si currentPassword et newPassword sont fournis, vérifier le mot de passe actuel
    if (body.currentPassword && body.newPassword) {
      ...
      // Ajouter le nouveau mot de passe en clair à data pour que userService.updateUser le gère
