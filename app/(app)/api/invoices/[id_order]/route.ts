...
export async function GET(
  ...
  try {
    ...
    // Vérifier les permissions ou la propriété de la commande
    const hasViewPermission = hasPermission(userRole, "orders:view")
    if (!hasViewPermission && order.id_user !== parseInt(userId)) {
      return NextResponse.json(
