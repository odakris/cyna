...
const ProductPage = () => {
  ...
  const handleAddToCart = (subscriptionType: string) => {
    ...
    const normalizedSubscription = subscriptionType.toUpperCase(); // Normalisation en majuscules
    addToCart({
            ...
            <table className="w-full max-w-screen-lg mx-auto table-auto border-collapse border border-gray-300">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border px-4 py-2 text-center">{prixUnitaire} €</td>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2 text-center">
                    <Button
                      onClick={() => handleAddToCart("PER_MARCHINE")}
                      className="w-auto py-1 text-sm"
                      variant="cyna"
                    >
                      Ajouter au panier
